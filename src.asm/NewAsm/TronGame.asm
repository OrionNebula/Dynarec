...
#mode text
	...
	CallMethod(:loadDeviceDescriptors:)
	...
	do
		...
		CallMethod(:initEnemyCycle:)
		CallMethod(:renderLightCycle:)
...
:gameTick:
	...
	do
		...
		if(r1 != r2)
			CallMethod(:runAITick:)
			CallMethod(:moveLightCycle:)
		end
